...
<ul class="sidenav" id="mobile-demo">
   ...
   <li><a href="{{ route('login') }}" >Iniciar sesion</a></li>
    ...
    @endauth
		    ...
		    <div id="modal1" class="modal">
			    <div class="modal-content">
			      <h4>Modulo Biblioteca</h4>
			   <img src="{{asset('img/bicipuerto.jpg')}}" class="responsive-img" alt="">
			   </div>
 			</div>	

 			<div id="modal2" class="modal">
			    <div class="modal-content">
			      <h4>Modulo Medicina</h4>
			   <img src="{{asset('img/bicipuerto.jpg')}}" class="responsive-img" alt="">
			   </div>
 			</div>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAu2rb0mobiznVJnJd6bVb5Bn2WsuXP2QI&callback=initMap"
    async defer></script>
